      ...
      <div className="container flex items-center justify-center h-full py-32 mx-auto text-center xl:text-left">
        ...
        <div className="flex flex-col w-full max-w-[700px] ">
          ...
          >
            ...
            <button className="border rounded-full btn border-white/50 max-w-[170px] px-8 transition-all duration-300 flex items-center justify-center overflow-hidden hover:border-accent group">
